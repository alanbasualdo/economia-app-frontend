        ...
        <td>
          <select
            ...
            onChange={(event) => {
              ...
              let haberInput = document.getElementsByName(`haber_${i}`)[0];
              haberInput = selectedValue === "+A";
            }}
          >
            <option defaultValue=""></option>
            <optgroup label="Ingresos (+)">
              <option className="text-success" value="+A">
                +A
              </option>
              <option className="text-success" value="+RN">
                +RN
              </option>
              <option className="text-success" value="+P">
                +P
              </option>
              <option className="text-success" value="+PN">
                +PN
              </option>
              <option className="text-success" value="+RP">
                +RP
              </option>
            </optgroup>
            <optgroup label="Egresos (-)">
              <option className="text-danger" value="-A">
                -A
              </option>
              <option className="text-danger" value="-RN">
                -RN
              </option>
              <option className="text-danger" value="-P">
                -P
              </option>
              <option className="text-danger" value="-PN">
                -PN
              </option>
              <option className="text-danger" value="-RP">
                -RP
              </option>
            </optgroup>
          </select>
        ...
        <table className="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td></td>
              <td className="text-center" name="total-debe">
                <h5>
                  <b>${totalDebe.toFixed(2)}</b>
                </h5>
              </td>
              <td className="text-center" name="total-haber">
                <h5>
                  <b>${totalHaber.toFixed(2)}</b>
                </h5>
              </td>
            </tr>
          </tbody>
